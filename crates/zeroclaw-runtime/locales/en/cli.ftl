...
# Swarm CLI + dashboard TUI (`zeroclaw swarm`)
cli-swarm-list-empty = No swarms stored.
cli-swarm-list-row = { $swarm_id }  { $name }  status={ $status }  boxes={ $boxes }  budget={ $budget }  updated={ $updated }
cli-swarm-deleted = Deleted swarm { $swarm_id }.
cli-swarm-delete-absent = No swarm { $swarm_id } to delete.
cli-swarm-needs-tty = `zeroclaw swarm` needs a terminal. Use `zeroclaw swarm list` when the output is piped.
cli-swarm-unsupported = This daemon has no swarm methods; it was built before swarms existed.
cli-swarm-call-failed = The daemon refused the call: { $message }
cli-swarm-daemon-dropped = The daemon closed the connection.
cli-swarm-daemon-not-ready = The daemon started but never bound { $socket }.
cli-swarm-status-created = created
cli-swarm-status-running = running
cli-swarm-status-paused = paused
cli-swarm-status-paused-detail = paused ({ $reason })
cli-swarm-status-stopped = stopped
cli-swarm-status-completed = completed
cli-swarm-pause-budget-exhausted = budget exhausted
cli-swarm-pause-daemon-restart = daemon restart
cli-swarm-pause-user-requested = user requested
cli-swarm-budget-custom = custom
cli-swarm-wizard-name-title = Name
cli-swarm-wizard-name-help = What this swarm is called in the dashboard.
cli-swarm-tui-title = ZeroClaw swarms
cli-swarm-tui-col-name = Name
cli-swarm-tui-col-status = Status
cli-swarm-tui-col-boxes = Boxes
cli-swarm-tui-col-budget = Budget
cli-swarm-tui-col-updated = Updated
cli-swarm-tui-col-slot = Slot
cli-swarm-tui-col-box = Box
cli-swarm-tui-col-role = Role
cli-swarm-tui-col-job = Job
cli-swarm-tui-new-row = + New swarm
cli-swarm-tui-loading = Working...
cli-swarm-tui-keys-dashboard = up/down move · enter open · d delete · r refresh · q quit
cli-swarm-tui-keys-detail = esc back · q quit
cli-swarm-tui-keys-wizard = enter next · esc back · tab field · up/down choose · ctrl+c quit
cli-swarm-tui-created = Created { $name }.
cli-swarm-tui-deleted = Deleted { $swarm_id }.
cli-swarm-tui-detail-title = Swarm { $name }
cli-swarm-tui-detail-missing = That swarm is gone.
cli-swarm-tui-field-id = Id
cli-swarm-tui-field-status = Status
cli-swarm-tui-field-provider = Provider
cli-swarm-tui-field-model = Model
cli-swarm-tui-field-risk = Risk profile
cli-swarm-tui-field-budget = Budget
cli-swarm-tui-field-spent = Spent
cli-swarm-tui-field-channels = Channels
cli-swarm-tui-field-role = Role
cli-swarm-tui-field-goal = Goal
cli-swarm-tui-roster = Roster
cli-swarm-tui-box-unassigned = unassigned
cli-swarm-tui-wizard-loading = Asking the daemon for the wizard steps...
cli-swarm-tui-wizard-title = New swarm — step { $step } of { $total }: { $title }
cli-swarm-tui-wizard-submitting = Creating the swarm...
cli-swarm-tui-wizard-advisory = config only — set it with `zeroclaw config`
cli-swarm-tui-wizard-advisory-only = Nothing to answer here.
cli-swarm-tui-wizard-choices = choices: { $choices }
cli-swarm-tui-confirm-delete = Delete swarm { $swarm_id }?
cli-swarm-tui-confirm-delete-force = A live run holds swarm { $swarm_id }. Delete anyway?
cli-swarm-tui-confirm-keys = y delete · n cancel
cli-swarm-tui-error-keys = any key to dismiss
cli-swarm-tui-unsupported-title = This daemon has no swarms
cli-swarm-tui-unsupported-body = The daemon behind this socket was built before swarms existed. Upgrade it, or stop it and let `zeroclaw swarm` start a matching one.
cli-swarm-tui-unsupported-keys = any key to quit

# ── Live multi-box canvas (S9) ──
cli-swarm-tui-view-empty = This swarm has no boxes.
cli-swarm-tui-budget-bar = turns { $turns }/{ $max_turns } · tokens { $tokens }/{ $max_tokens } · { $cost }/{ $max_cost } USD
cli-swarm-tui-cell-role = role
cli-swarm-tui-cell-job = job
cli-swarm-tui-cell-waiting = waiting…
cli-swarm-tui-badge-idle = idle
cli-swarm-tui-badge-working = working
cli-swarm-tui-badge-blocked = blocked
cli-swarm-tui-badge-done = done
cli-swarm-tui-badge-claim = claim { $claim }
cli-swarm-tui-badge-engaged = (you)
cli-swarm-tui-badge-ctx = ctx { $tokens }/{ $ceiling }
cli-swarm-tui-stream-gap = … (stream gap)
cli-swarm-tui-feed-label = Broadcast
cli-swarm-tui-feed-empty = no board activity yet
cli-swarm-tui-feed-gap = … (stream gap)
cli-swarm-tui-feed-published = { $box }: { $status }
cli-swarm-tui-feed-claimed = { $box } claimed { $key }
cli-swarm-tui-feed-released = { $box } released { $key }
cli-swarm-tui-feed-reaped = board reaped
cli-swarm-tui-feed-chat = { $box } engaged by you
cli-swarm-tui-feed-handback = { $box } handed back
cli-swarm-tui-chat-prompt = chat { $box } >
cli-swarm-tui-line-tool = → { $tool }
cli-swarm-tui-line-tool-result = ✓ { $tool }
cli-swarm-tui-line-approval = approval: { $tool }
cli-swarm-tui-line-plan = plan updated ({ $count })
cli-swarm-tui-line-turn-done = turn complete
cli-swarm-tui-line-turn-cancelled = turn cancelled
cli-swarm-tui-line-turn-failed = turn failed
cli-swarm-tui-line-trimmed = context trimmed
cli-swarm-tui-keys-view = arrows focus · enter chat · e edit · m move · s/p/r/x run · esc back · q quit
cli-swarm-tui-keys-chat = type message · enter send · "resume" hands back · esc cancel
cli-swarm-tui-keys-edit = type · tab role/job · enter save · esc cancel
cli-swarm-tui-keys-move = arrows swap · enter/m/esc drop
