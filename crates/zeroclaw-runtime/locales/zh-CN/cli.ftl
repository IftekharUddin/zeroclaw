...
# 蜂群 CLI 与仪表盘 TUI (`zeroclaw swarm`)
cli-swarm-list-empty = 没有已保存的蜂群。
cli-swarm-list-row = { $swarm_id }  { $name }  状态={ $status }  盒子={ $boxes }  预算={ $budget }  更新={ $updated }
cli-swarm-deleted = 已删除蜂群 { $swarm_id }。
cli-swarm-delete-absent = 没有可删除的蜂群 { $swarm_id }。
cli-swarm-needs-tty = `zeroclaw swarm` 需要终端。输出被重定向时请使用 `zeroclaw swarm list`。
cli-swarm-unsupported = 该守护进程没有蜂群方法；它是在蜂群功能之前构建的。
cli-swarm-call-failed = 守护进程拒绝了该调用：{ $message }
cli-swarm-daemon-dropped = 守护进程关闭了连接。
cli-swarm-daemon-not-ready = 守护进程已启动，但始终未绑定 { $socket }。
cli-swarm-status-created = 已创建
cli-swarm-status-running = 运行中
cli-swarm-status-paused = 已暂停
cli-swarm-status-paused-detail = 已暂停（{ $reason }）
cli-swarm-status-stopped = 已停止
cli-swarm-status-completed = 已完成
cli-swarm-pause-budget-exhausted = 预算耗尽
cli-swarm-pause-daemon-restart = 守护进程重启
cli-swarm-pause-user-requested = 用户请求
cli-swarm-budget-custom = 自定义
cli-swarm-wizard-name-title = 名称
cli-swarm-wizard-name-help = 该蜂群在仪表盘中显示的名称。
cli-swarm-tui-title = ZeroClaw 蜂群
cli-swarm-tui-col-name = 名称
cli-swarm-tui-col-status = 状态
cli-swarm-tui-col-boxes = 盒子
cli-swarm-tui-col-budget = 预算
cli-swarm-tui-col-updated = 更新时间
cli-swarm-tui-col-slot = 槽位
cli-swarm-tui-col-box = 盒子
cli-swarm-tui-col-role = 角色
cli-swarm-tui-col-job = 任务
cli-swarm-tui-new-row = + 新建蜂群
cli-swarm-tui-loading = 处理中...
cli-swarm-tui-keys-dashboard = 上下 移动 · enter 打开 · d 删除 · r 刷新 · q 退出
cli-swarm-tui-keys-detail = esc 返回 · q 退出
cli-swarm-tui-keys-wizard = enter 下一步 · esc 返回 · tab 切换字段 · 上下 选择 · ctrl+c 退出
cli-swarm-tui-created = 已创建 { $name }。
cli-swarm-tui-deleted = 已删除 { $swarm_id }。
cli-swarm-tui-detail-title = 蜂群 { $name }
cli-swarm-tui-detail-missing = 该蜂群已不存在。
cli-swarm-tui-field-id = Id
cli-swarm-tui-field-status = 状态
cli-swarm-tui-field-provider = 提供方
cli-swarm-tui-field-model = 模型
cli-swarm-tui-field-risk = 风险配置
cli-swarm-tui-field-budget = 预算
cli-swarm-tui-field-spent = 已消耗
cli-swarm-tui-field-channels = 通道
cli-swarm-tui-field-role = 角色
cli-swarm-tui-field-goal = 目标
cli-swarm-tui-roster = 编制
cli-swarm-tui-box-unassigned = 未分配
cli-swarm-tui-wizard-loading = 正在向守护进程请求向导步骤...
cli-swarm-tui-wizard-title = 新建蜂群 — 第 { $step } 步，共 { $total } 步：{ $title }
cli-swarm-tui-wizard-submitting = 正在创建蜂群...
cli-swarm-tui-wizard-advisory = 仅配置项 — 请用 `zeroclaw config` 设置
cli-swarm-tui-wizard-advisory-only = 此处没有需要填写的内容。
cli-swarm-tui-wizard-choices = 可选值：{ $choices }
cli-swarm-tui-confirm-delete = 删除蜂群 { $swarm_id }？
cli-swarm-tui-confirm-delete-force = 有正在运行的任务持有蜂群 { $swarm_id }。仍要删除吗？
cli-swarm-tui-confirm-keys = y 删除 · n 取消
cli-swarm-tui-error-keys = 按任意键关闭
cli-swarm-tui-unsupported-title = 该守护进程没有蜂群
cli-swarm-tui-unsupported-body = 该套接字背后的守护进程是在蜂群功能之前构建的。请升级它，或停止它并让 `zeroclaw swarm` 启动一个匹配的实例。
cli-swarm-tui-unsupported-keys = 按任意键退出

# ── 实时多框画布 (S9) ──
cli-swarm-tui-view-empty = 该蜂群没有任何框。
cli-swarm-tui-budget-bar = 轮次 { $turns }/{ $max_turns } · 令牌 { $tokens }/{ $max_tokens } · { $cost }/{ $max_cost } USD
cli-swarm-tui-cell-role = 角色
cli-swarm-tui-cell-job = 任务
cli-swarm-tui-cell-waiting = 等待中…
cli-swarm-tui-badge-idle = 空闲
cli-swarm-tui-badge-working = 工作中
cli-swarm-tui-badge-blocked = 阻塞
cli-swarm-tui-badge-done = 完成
cli-swarm-tui-badge-claim = 认领 { $claim }
cli-swarm-tui-badge-engaged = (你)
cli-swarm-tui-badge-ctx = ctx { $tokens }/{ $ceiling }
cli-swarm-tui-stream-gap = … (流中断)
cli-swarm-tui-feed-label = 广播
cli-swarm-tui-feed-empty = 暂无看板活动
cli-swarm-tui-feed-gap = … (流中断)
cli-swarm-tui-feed-published = { $box }：{ $status }
cli-swarm-tui-feed-claimed = { $box } 认领了 { $key }
cli-swarm-tui-feed-released = { $box } 释放了 { $key }
cli-swarm-tui-feed-reaped = 看板已回收
cli-swarm-tui-feed-chat = { $box } 由你接管
cli-swarm-tui-feed-handback = { $box } 已交还
cli-swarm-tui-chat-prompt = 聊天 { $box } >
cli-swarm-tui-line-tool = → { $tool }
cli-swarm-tui-line-tool-result = ✓ { $tool }
cli-swarm-tui-line-approval = 审批：{ $tool }
cli-swarm-tui-line-plan = 计划已更新 ({ $count })
cli-swarm-tui-line-turn-done = 轮次完成
cli-swarm-tui-line-turn-cancelled = 轮次取消
cli-swarm-tui-line-turn-failed = 轮次失败
cli-swarm-tui-line-trimmed = 上下文已裁剪
cli-swarm-tui-keys-view = 方向键 聚焦 · enter 聊天 · e 编辑 · m 移动 · s/p/r/x 运行 · esc 返回 · q 退出
cli-swarm-tui-keys-chat = 输入消息 · enter 发送 · “resume” 交还 · esc 取消
cli-swarm-tui-keys-edit = 输入 · tab 角色/任务 · enter 保存 · esc 取消
cli-swarm-tui-keys-move = 方向键 交换 · enter/m/esc 放下
