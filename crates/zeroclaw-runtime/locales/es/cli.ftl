...
# CLI de enjambres y TUI del panel (`zeroclaw swarm`)
cli-swarm-list-empty = No hay enjambres almacenados.
cli-swarm-list-row = { $swarm_id }  { $name }  estado={ $status }  cajas={ $boxes }  presupuesto={ $budget }  actualizado={ $updated }
cli-swarm-deleted = Enjambre { $swarm_id } eliminado.
cli-swarm-delete-absent = No hay ningún enjambre { $swarm_id } que eliminar.
cli-swarm-needs-tty = `zeroclaw swarm` necesita una terminal. Usa `zeroclaw swarm list` cuando la salida esté redirigida.
cli-swarm-unsupported = Este daemon no tiene métodos de enjambre; se compiló antes de que existieran los enjambres.
cli-swarm-call-failed = El daemon rechazó la llamada: { $message }
cli-swarm-daemon-dropped = El daemon cerró la conexión.
cli-swarm-daemon-not-ready = El daemon arrancó pero nunca abrió { $socket }.
cli-swarm-status-created = creado
cli-swarm-status-running = en curso
cli-swarm-status-paused = en pausa
cli-swarm-status-paused-detail = en pausa ({ $reason })
cli-swarm-status-stopped = detenido
cli-swarm-status-completed = completado
cli-swarm-pause-budget-exhausted = presupuesto agotado
cli-swarm-pause-daemon-restart = reinicio del daemon
cli-swarm-pause-user-requested = solicitado por el usuario
cli-swarm-budget-custom = personalizado
cli-swarm-wizard-name-title = Nombre
cli-swarm-wizard-name-help = Cómo se llama este enjambre en el panel.
cli-swarm-tui-title = Enjambres de ZeroClaw
cli-swarm-tui-col-name = Nombre
cli-swarm-tui-col-status = Estado
cli-swarm-tui-col-boxes = Cajas
cli-swarm-tui-col-budget = Presup.
cli-swarm-tui-col-updated = Actualizado
cli-swarm-tui-col-slot = Ranura
cli-swarm-tui-col-box = Caja
cli-swarm-tui-col-role = Rol
cli-swarm-tui-col-job = Tarea
cli-swarm-tui-new-row = + Nuevo enjambre
cli-swarm-tui-loading = Trabajando...
cli-swarm-tui-keys-dashboard = arriba/abajo mover · enter abrir · d eliminar · r recargar · q salir
cli-swarm-tui-keys-detail = esc volver · q salir
cli-swarm-tui-keys-wizard = enter siguiente · esc volver · tab campo · arriba/abajo elegir · ctrl+c salir
cli-swarm-tui-created = Se creó { $name }.
cli-swarm-tui-deleted = Se eliminó { $swarm_id }.
cli-swarm-tui-detail-title = Enjambre { $name }
cli-swarm-tui-detail-missing = Ese enjambre ya no existe.
cli-swarm-tui-field-id = Id
cli-swarm-tui-field-status = Estado
cli-swarm-tui-field-provider = Proveedor
cli-swarm-tui-field-model = Modelo
cli-swarm-tui-field-risk = Perfil de riesgo
cli-swarm-tui-field-budget = Presupuesto
cli-swarm-tui-field-spent = Gastado
cli-swarm-tui-field-channels = Canales
cli-swarm-tui-field-role = Rol
cli-swarm-tui-field-goal = Objetivo
cli-swarm-tui-roster = Plantilla
cli-swarm-tui-box-unassigned = sin asignar
cli-swarm-tui-wizard-loading = Pidiendo al daemon los pasos del asistente...
cli-swarm-tui-wizard-title = Nuevo enjambre — paso { $step } de { $total }: { $title }
cli-swarm-tui-wizard-submitting = Creando el enjambre...
cli-swarm-tui-wizard-advisory = solo configuración — defínelo con `zeroclaw config`
cli-swarm-tui-wizard-advisory-only = Aquí no hay nada que responder.
cli-swarm-tui-wizard-choices = opciones: { $choices }
cli-swarm-tui-confirm-delete = ¿Eliminar el enjambre { $swarm_id }?
cli-swarm-tui-confirm-delete-force = Una ejecución activa retiene el enjambre { $swarm_id }. ¿Eliminarlo igualmente?
cli-swarm-tui-confirm-keys = y eliminar · n cancelar
cli-swarm-tui-error-keys = cualquier tecla para descartar
cli-swarm-tui-unsupported-title = Este daemon no tiene enjambres
cli-swarm-tui-unsupported-body = El daemon detrás de este socket se compiló antes de que existieran los enjambres. Actualízalo, o deténlo y deja que `zeroclaw swarm` arranque uno compatible.
cli-swarm-tui-unsupported-keys = cualquier tecla para salir

# ── Lienzo multibox en vivo (S9) ──
cli-swarm-tui-view-empty = Este enjambre no tiene cajas.
cli-swarm-tui-budget-bar = turnos { $turns }/{ $max_turns } · tokens { $tokens }/{ $max_tokens } · { $cost }/{ $max_cost } USD
cli-swarm-tui-cell-role = rol
cli-swarm-tui-cell-job = tarea
cli-swarm-tui-cell-waiting = esperando…
cli-swarm-tui-badge-idle = inactiva
cli-swarm-tui-badge-working = trabajando
cli-swarm-tui-badge-blocked = bloqueada
cli-swarm-tui-badge-done = lista
cli-swarm-tui-badge-claim = reclamo { $claim }
cli-swarm-tui-badge-engaged = (tú)
cli-swarm-tui-badge-ctx = ctx { $tokens }/{ $ceiling }
cli-swarm-tui-stream-gap = … (hueco de flujo)
cli-swarm-tui-feed-label = Difusión
cli-swarm-tui-feed-empty = aún no hay actividad del tablero
cli-swarm-tui-feed-gap = … (hueco de flujo)
cli-swarm-tui-feed-published = { $box }: { $status }
cli-swarm-tui-feed-claimed = { $box } reclamó { $key }
cli-swarm-tui-feed-released = { $box } liberó { $key }
cli-swarm-tui-feed-reaped = tablero recogido
cli-swarm-tui-feed-chat = { $box } atendida por ti
cli-swarm-tui-feed-handback = { $box } devuelta
cli-swarm-tui-chat-prompt = chat { $box } >
cli-swarm-tui-line-tool = → { $tool }
cli-swarm-tui-line-tool-result = ✓ { $tool }
cli-swarm-tui-line-approval = aprobación: { $tool }
cli-swarm-tui-line-plan = plan actualizado ({ $count })
cli-swarm-tui-line-turn-done = turno completado
cli-swarm-tui-line-turn-cancelled = turno cancelado
cli-swarm-tui-line-turn-failed = turno fallido
cli-swarm-tui-line-trimmed = contexto recortado
cli-swarm-tui-keys-view = flechas foco · enter chat · e editar · m mover · s/p/r/x ejecutar · esc volver · q salir
cli-swarm-tui-keys-chat = escribe mensaje · enter enviar · "resume" devuelve · esc cancelar
cli-swarm-tui-keys-edit = escribe · tab rol/tarea · enter guardar · esc cancelar
cli-swarm-tui-keys-move = flechas intercambiar · enter/m/esc soltar
