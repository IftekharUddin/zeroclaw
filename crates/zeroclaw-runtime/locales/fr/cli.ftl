...
# CLI des essaims et TUI du tableau de bord (`zeroclaw swarm`)
cli-swarm-list-empty = Aucun essaim enregistré.
cli-swarm-list-row = { $swarm_id }  { $name }  état={ $status }  boîtes={ $boxes }  budget={ $budget }  màj={ $updated }
cli-swarm-deleted = Essaim { $swarm_id } supprimé.
cli-swarm-delete-absent = Aucun essaim { $swarm_id } à supprimer.
cli-swarm-needs-tty = `zeroclaw swarm` nécessite un terminal. Utilisez `zeroclaw swarm list` lorsque la sortie est redirigée.
cli-swarm-unsupported = Ce démon n'a pas de méthodes d'essaim ; il a été compilé avant l'existence des essaims.
cli-swarm-call-failed = Le démon a refusé l'appel : { $message }
cli-swarm-daemon-dropped = Le démon a fermé la connexion.
cli-swarm-daemon-not-ready = Le démon a démarré mais n'a jamais ouvert { $socket }.
cli-swarm-status-created = créé
cli-swarm-status-running = en cours
cli-swarm-status-paused = en pause
cli-swarm-status-paused-detail = en pause ({ $reason })
cli-swarm-status-stopped = arrêté
cli-swarm-status-completed = terminé
cli-swarm-pause-budget-exhausted = budget épuisé
cli-swarm-pause-daemon-restart = redémarrage du démon
cli-swarm-pause-user-requested = demandé par l'utilisateur
cli-swarm-budget-custom = personnalisé
cli-swarm-wizard-name-title = Nom
cli-swarm-wizard-name-help = Le nom de cet essaim dans le tableau de bord.
cli-swarm-tui-title = Essaims ZeroClaw
cli-swarm-tui-col-name = Nom
cli-swarm-tui-col-status = État
cli-swarm-tui-col-boxes = Boîtes
cli-swarm-tui-col-budget = Budget
cli-swarm-tui-col-updated = Mise à jour
cli-swarm-tui-col-slot = Case
cli-swarm-tui-col-box = Boîte
cli-swarm-tui-col-role = Rôle
cli-swarm-tui-col-job = Tâche
cli-swarm-tui-new-row = + Nouvel essaim
cli-swarm-tui-loading = Traitement...
cli-swarm-tui-keys-dashboard = haut/bas déplacer · entrée ouvrir · d supprimer · r recharger · q quitter
cli-swarm-tui-keys-detail = échap retour · q quitter
cli-swarm-tui-keys-wizard = entrée suivant · échap retour · tab champ · haut/bas choisir · ctrl+c quitter
cli-swarm-tui-created = { $name } créé.
cli-swarm-tui-deleted = { $swarm_id } supprimé.
cli-swarm-tui-detail-title = Essaim { $name }
cli-swarm-tui-detail-missing = Cet essaim n'existe plus.
cli-swarm-tui-field-id = Id
cli-swarm-tui-field-status = État
cli-swarm-tui-field-provider = Fournisseur
cli-swarm-tui-field-model = Modèle
cli-swarm-tui-field-risk = Profil de risque
cli-swarm-tui-field-budget = Budget
cli-swarm-tui-field-spent = Dépensé
cli-swarm-tui-field-channels = Canaux
cli-swarm-tui-field-role = Rôle
cli-swarm-tui-field-goal = Objectif
cli-swarm-tui-roster = Effectif
cli-swarm-tui-box-unassigned = non attribué
cli-swarm-tui-wizard-loading = Demande des étapes de l'assistant au démon...
cli-swarm-tui-wizard-title = Nouvel essaim — étape { $step } sur { $total } : { $title }
cli-swarm-tui-wizard-submitting = Création de l'essaim...
cli-swarm-tui-wizard-advisory = configuration seulement — définissez-le avec `zeroclaw config`
cli-swarm-tui-wizard-advisory-only = Rien à renseigner ici.
cli-swarm-tui-wizard-choices = choix : { $choices }
cli-swarm-tui-confirm-delete = Supprimer l'essaim { $swarm_id } ?
cli-swarm-tui-confirm-delete-force = Une exécution active détient l'essaim { $swarm_id }. Le supprimer quand même ?
cli-swarm-tui-confirm-keys = y supprimer · n annuler
cli-swarm-tui-error-keys = une touche pour fermer
cli-swarm-tui-unsupported-title = Ce démon n'a pas d'essaims
cli-swarm-tui-unsupported-body = Le démon derrière ce socket a été compilé avant l'existence des essaims. Mettez-le à jour, ou arrêtez-le et laissez `zeroclaw swarm` en démarrer un compatible.
cli-swarm-tui-unsupported-keys = une touche pour quitter

# ── Canevas multi-boîtes en direct (S9) ──
cli-swarm-tui-view-empty = Cet essaim n'a aucune boîte.
cli-swarm-tui-budget-bar = tours { $turns }/{ $max_turns } · jetons { $tokens }/{ $max_tokens } · { $cost }/{ $max_cost } USD
cli-swarm-tui-cell-role = rôle
cli-swarm-tui-cell-job = tâche
cli-swarm-tui-cell-waiting = en attente…
cli-swarm-tui-badge-idle = au repos
cli-swarm-tui-badge-working = au travail
cli-swarm-tui-badge-blocked = bloquée
cli-swarm-tui-badge-done = terminée
cli-swarm-tui-badge-claim = revendication { $claim }
cli-swarm-tui-badge-engaged = (vous)
cli-swarm-tui-badge-ctx = ctx { $tokens }/{ $ceiling }
cli-swarm-tui-stream-gap = … (trou de flux)
cli-swarm-tui-feed-label = Diffusion
cli-swarm-tui-feed-empty = aucune activité du tableau pour l'instant
cli-swarm-tui-feed-gap = … (trou de flux)
cli-swarm-tui-feed-published = { $box } : { $status }
cli-swarm-tui-feed-claimed = { $box } a revendiqué { $key }
cli-swarm-tui-feed-released = { $box } a libéré { $key }
cli-swarm-tui-feed-reaped = tableau récupéré
cli-swarm-tui-feed-chat = { $box } prise en charge par vous
cli-swarm-tui-feed-handback = { $box } rendue
cli-swarm-tui-chat-prompt = chat { $box } >
cli-swarm-tui-line-tool = → { $tool }
cli-swarm-tui-line-tool-result = ✓ { $tool }
cli-swarm-tui-line-approval = approbation : { $tool }
cli-swarm-tui-line-plan = plan mis à jour ({ $count })
cli-swarm-tui-line-turn-done = tour terminé
cli-swarm-tui-line-turn-cancelled = tour annulé
cli-swarm-tui-line-turn-failed = tour échoué
cli-swarm-tui-line-trimmed = contexte tronqué
cli-swarm-tui-keys-view = flèches focus · entrée chat · e éditer · m déplacer · s/p/r/x exécuter · échap retour · q quitter
cli-swarm-tui-keys-chat = tapez un message · entrée envoyer · « resume » rend la main · échap annuler
cli-swarm-tui-keys-edit = tapez · tab rôle/tâche · entrée enregistrer · échap annuler
cli-swarm-tui-keys-move = flèches échanger · entrée/m/échap lâcher
