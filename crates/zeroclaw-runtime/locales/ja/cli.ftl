...
# スウォーム CLI とダッシュボード TUI (`zeroclaw swarm`)
cli-swarm-list-empty = 保存されたスウォームはありません。
cli-swarm-list-row = { $swarm_id }  { $name }  状態={ $status }  ボックス={ $boxes }  予算={ $budget }  更新={ $updated }
cli-swarm-deleted = スウォーム { $swarm_id } を削除しました。
cli-swarm-delete-absent = 削除するスウォーム { $swarm_id } はありません。
cli-swarm-needs-tty = `zeroclaw swarm` には端末が必要です。出力をパイプする場合は `zeroclaw swarm list` を使ってください。
cli-swarm-unsupported = このデーモンにはスウォームのメソッドがありません。スウォーム導入前のビルドです。
cli-swarm-call-failed = デーモンが呼び出しを拒否しました: { $message }
cli-swarm-daemon-dropped = デーモンが接続を閉じました。
cli-swarm-daemon-not-ready = デーモンは起動しましたが { $socket } を開きませんでした。
cli-swarm-status-created = 作成済み
cli-swarm-status-running = 実行中
cli-swarm-status-paused = 一時停止
cli-swarm-status-paused-detail = 一時停止 ({ $reason })
cli-swarm-status-stopped = 停止
cli-swarm-status-completed = 完了
cli-swarm-pause-budget-exhausted = 予算超過
cli-swarm-pause-daemon-restart = デーモン再起動
cli-swarm-pause-user-requested = ユーザー要求
cli-swarm-budget-custom = カスタム
cli-swarm-wizard-name-title = 名前
cli-swarm-wizard-name-help = ダッシュボードでのこのスウォームの表示名です。
cli-swarm-tui-title = ZeroClaw スウォーム
cli-swarm-tui-col-name = 名前
cli-swarm-tui-col-status = 状態
cli-swarm-tui-col-boxes = ボックス
cli-swarm-tui-col-budget = 予算
cli-swarm-tui-col-updated = 更新
cli-swarm-tui-col-slot = 枠
cli-swarm-tui-col-box = ボックス
cli-swarm-tui-col-role = 役割
cli-swarm-tui-col-job = 仕事
cli-swarm-tui-new-row = + 新しいスウォーム
cli-swarm-tui-loading = 処理中...
cli-swarm-tui-keys-dashboard = 上下 移動 · enter 開く · d 削除 · r 再読込 · q 終了
cli-swarm-tui-keys-detail = esc 戻る · q 終了
cli-swarm-tui-keys-wizard = enter 次へ · esc 戻る · tab 項目 · 上下 選択 · ctrl+c 終了
cli-swarm-tui-created = { $name } を作成しました。
cli-swarm-tui-deleted = { $swarm_id } を削除しました。
cli-swarm-tui-detail-title = スウォーム { $name }
cli-swarm-tui-detail-missing = そのスウォームは存在しません。
cli-swarm-tui-field-id = Id
cli-swarm-tui-field-status = 状態
cli-swarm-tui-field-provider = プロバイダー
cli-swarm-tui-field-model = モデル
cli-swarm-tui-field-risk = リスクプロファイル
cli-swarm-tui-field-budget = 予算
cli-swarm-tui-field-spent = 消費
cli-swarm-tui-field-channels = チャネル
cli-swarm-tui-field-role = 役割
cli-swarm-tui-field-goal = 目的
cli-swarm-tui-roster = 編成
cli-swarm-tui-box-unassigned = 未割り当て
cli-swarm-tui-wizard-loading = ウィザードのステップをデーモンに問い合わせています...
cli-swarm-tui-wizard-title = 新しいスウォーム — ステップ { $step } / { $total }: { $title }
cli-swarm-tui-wizard-submitting = スウォームを作成しています...
cli-swarm-tui-wizard-advisory = 設定項目です — `zeroclaw config` で設定してください
cli-swarm-tui-wizard-advisory-only = ここに入力する項目はありません。
cli-swarm-tui-wizard-choices = 選択肢: { $choices }
cli-swarm-tui-confirm-delete = スウォーム { $swarm_id } を削除しますか?
cli-swarm-tui-confirm-delete-force = 実行中のランがスウォーム { $swarm_id } を保持しています。それでも削除しますか?
cli-swarm-tui-confirm-keys = y 削除 · n 中止
cli-swarm-tui-error-keys = 任意のキーで閉じる
cli-swarm-tui-unsupported-title = このデーモンにはスウォームがありません
cli-swarm-tui-unsupported-body = このソケットのデーモンはスウォーム導入前のビルドです。更新するか、停止して `zeroclaw swarm` に対応するデーモンを起動させてください。
cli-swarm-tui-unsupported-keys = 任意のキーで終了

# ── ライブ・マルチボックス・キャンバス (S9) ──
cli-swarm-tui-view-empty = このスウォームにはボックスがありません。
cli-swarm-tui-budget-bar = ターン { $turns }/{ $max_turns } · トークン { $tokens }/{ $max_tokens } · { $cost }/{ $max_cost } USD
cli-swarm-tui-cell-role = 役割
cli-swarm-tui-cell-job = 仕事
cli-swarm-tui-cell-waiting = 待機中…
cli-swarm-tui-badge-idle = 待機
cli-swarm-tui-badge-working = 作業中
cli-swarm-tui-badge-blocked = ブロック
cli-swarm-tui-badge-done = 完了
cli-swarm-tui-badge-claim = 確保 { $claim }
cli-swarm-tui-badge-engaged = (あなた)
cli-swarm-tui-badge-ctx = ctx { $tokens }/{ $ceiling }
cli-swarm-tui-stream-gap = … (ストリーム欠落)
cli-swarm-tui-feed-label = ブロードキャスト
cli-swarm-tui-feed-empty = ボードの活動はまだありません
cli-swarm-tui-feed-gap = … (ストリーム欠落)
cli-swarm-tui-feed-published = { $box }: { $status }
cli-swarm-tui-feed-claimed = { $box } が { $key } を確保
cli-swarm-tui-feed-released = { $box } が { $key } を解放
cli-swarm-tui-feed-reaped = ボードを回収しました
cli-swarm-tui-feed-chat = { $box } をあなたが担当
cli-swarm-tui-feed-handback = { $box } を返却
cli-swarm-tui-chat-prompt = チャット { $box } >
cli-swarm-tui-line-tool = → { $tool }
cli-swarm-tui-line-tool-result = ✓ { $tool }
cli-swarm-tui-line-approval = 承認: { $tool }
cli-swarm-tui-line-plan = プラン更新 ({ $count })
cli-swarm-tui-line-turn-done = ターン完了
cli-swarm-tui-line-turn-cancelled = ターン中止
cli-swarm-tui-line-turn-failed = ターン失敗
cli-swarm-tui-line-trimmed = コンテキストを整理しました
cli-swarm-tui-keys-view = 矢印 フォーカス · enter チャット · e 編集 · m 移動 · s/p/r/x 実行 · esc 戻る · q 終了
cli-swarm-tui-keys-chat = メッセージ入力 · enter 送信 · 「resume」で返却 · esc 取消
cli-swarm-tui-keys-edit = 入力 · tab 役割/仕事 · enter 保存 · esc 取消
cli-swarm-tui-keys-move = 矢印 入替 · enter/m/esc 離す
